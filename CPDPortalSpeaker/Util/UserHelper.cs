...
namespace CPDPortalSpeaker.Util
{
	public static class UserHelper
	{
		...
		public static void SpeakerActivationEmail(string LastName, string email, string password)
		{
		...
		private static string SpeakerActivationEmailBody(string LastName, string userName, string password)
		{
			...
			html = @"<table width='500' border='0' cellspacing='0' cellpadding='10'>
					...
					<td align='left'>
					   ...
					   <strong style='color:#125d9f'>https://speaker.ccpdhm.com</strong><br />
						...
						<p>Please ensure that you<strong style='color:#125d9f'> <u> enable cookies </u></strong> in your browser. Please reference the attached guide for a step by step process. </p>
						 ...
						 <p> Please sign-in with your username and password at <strong style='color:#125d9f'>https://speaker.ccpdhm.com</strong> to familiarize with the web portal and its’ functionalities. <br />
						 &nbsp;<br />  
			...
			<tr>    
				<td align='left'>
					Should you have any questions or require any assistance, please do not hesitate to contact us at <strong><U><a style='color:#125d9f' href='mailto:info@ccpdhm.com'>info@ccpdhm.com</a></U></strong><strong>
							...
							<strong>E:</strong> <strong><U><a href='mailto:info@ccpdhm.com'>info@ccpdhm.com </a></U></strong><br />
