...
namespace CPDPortalMVC.Util
{
	public static class UserHelper
	{
		...
		private static string RegisteredEmailBody(ProgramRequest pr, UserModel um, string ProgramName, string ModeratorName, string SessionCredits)
		{
			...
			<span style='color:blue'>Please note that an on-demand speaker training section has been added to the web portal.  
			We invite you to review the updated presentation.</span></p> 
		...
		private static string NotRegisteredBody(ProgramRequest pr, UserModel um, string ProgramName, string ModeratorName, string SessionCredits)
		{
			...
			<span style='color:blue'>4. Please note that an on-demand speaker training section has been added to the web portal.  We invite you to review the updated presentation. </span><br />
		...
		public static void SelectInvitationOption(ProgramRequest pr, string ModeratorName, string SessionCredit, Controller controller)
		{
